...
import org.apache.flink.table.descriptors.YHBaseValidator;
...
import static org.apache.flink.table.descriptors.YHBaseValidator.CONNECTOR_WRITE_BUFFER_FLUSH_INTERVAL;
import static org.apache.flink.table.descriptors.YHBaseValidator.CONNECTOR_WRITE_BUFFER_FLUSH_MAX_ROWS;
import static org.apache.flink.table.descriptors.YHBaseValidator.CONNECTOR_WRITE_BUFFER_FLUSH_MAX_SIZE;
 ...
 */
public class YHBaseTableFactory implements StreamTableSourceFactory<Row>, StreamTableSinkFactory<Tuple2<Boolean, Row>> {
    ...
    public StreamTableSource<Row> createStreamTableSource(Map<String, String> properties) {
        ...
        return new YHBaseTableSource(hbaseClientConf, hTableName, hbaseSchema, null);
    }
    ...
    private DescriptorProperties getValidatedProperties(Map<String, String> properties) {
        ...
        new YHBaseValidator().validate(descriptorProperties);
